...
## 游戏内文本使用的字体。
define gui.text_font = "SourceHanSansSC-Regular-2.otf"

## 角色名称使用的字体。
define gui.name_text_font = "YouShiSanGeng.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SourceHanSansSC-Regular-2.otf"
...
define gui.end_menu_background = "gui/end_menu.png"
